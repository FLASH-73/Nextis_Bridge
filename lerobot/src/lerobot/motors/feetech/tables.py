...
STS_SMS_SERIES_ENCODINGS_TABLE = {
    "Homing_Offset": ("twos", 2),
    "Goal_Velocity": ("twos", 2),
    "Goal_Speed": ("twos", 2),
    "Present_Velocity": ("twos", 2),
    "Present_Speed": ("twos", 2),
    "Present_Position": ("twos", 2),
    "Goal_Position": ("twos", 2),
    "Min_Position_Limit": ("twos", 2),
    "Max_Position_Limit": ("twos", 2),
}
