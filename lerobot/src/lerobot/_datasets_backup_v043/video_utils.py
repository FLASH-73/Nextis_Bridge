...
def encode_video_frames(
    ...
    video_path: Path | str,
    fps: int,
    vcodec: str = "h264",  # Changed from libsvtav1 - h264 is MUCH faster
    pix_fmt: str = "yuv420p",
    g: int | None = 15,  # Changed from 2 - much faster encoding, still good for random access
    crf: int | None = 30,
    fast_decode: int = 0,
    ...
    if vcodec == "libsvtav1":
        ...
        video_options["preset"] = "fast"  # Good balance of speed and quality
