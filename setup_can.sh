...
#
# This script configures the CAN bus interface (can0) for the Innomaker
# USB2CAN-X2 adapter (gs_usb driver) with proper TX queue length to
# prevent buffer overflow when controlling 7 motors at 60Hz.
