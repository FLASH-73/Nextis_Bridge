...
In 1948, John von Neumann proved something extraordinary. Just as Alan Turing had shown that a single machine could perform any computation, von Neumann showed that a single machine could build any physical object — given the right instructions.
...
Not because AI won't be transformative — it will. But because the story misunderstands people. Humans are not consumers. **Humans are builders.** We have spent 300,000 years making things with our hands. The urge to create is not a phase of economic history. It is who we are.
...
We start with industrial assembly, because that's where the pain is sharpest and the path to revenue is clear. But make no mistake about where we're going.
...
*Nextis — Building the Universal Constructor*
